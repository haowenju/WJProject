...
@interface GZBaseWebVC ()<WKNavigationDelegate>
...
- (WKWebView *)webView {
    if (!_webView) {
        ...
        CGRect f = CGRectMake(0, kTopHeight, self.view.bounds.size.width, kScreenHeight - kTopHeight);
