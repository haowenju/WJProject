...
const static CGFloat kCustomIOSAlertViewCornerRadius              = 12;
...
- (id)init
{
    ...
    if (self) {
        ...
        buttonTitles = @[@"取消"];
        buttonTitlesColor = @[[UIColor colorWithHexString:@"666666"]];
...
//    dialogContainer.layer.shadowColor = [UIColor blackColor].CGColor;
    ...
    lineView.backgroundColor = [UIColor colorWithHexString:@"F2F1F6"];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (buttonTitlesColor.count == buttonTitles.count) {
        ...
        if (i != 0) {
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 0.5, buttonHeight)];
            line.backgroundColor = [UIColor colorWithHexString:@"F2F1F6"];
            [closeButton addSubview:line];
        }
